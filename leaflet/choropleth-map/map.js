var mapboxAccessToken = 'pk.eyJ1IjoibWFsbGlrYTIwMTEiLCJhIjoiY2thbnExM2VrMDczejJybnlzaHN6bXowcSJ9.B5-rmmfvWVvIACNEIakmtQ';
var map = L.map('mapid', {
    // center: [51.505, -0.09],
    center:[0,0],
    zoom: 2,
...
var info = L.control();
    ...
    info.update = function (props) {
        this._div.innerHTML = '<h4>India Covid-19 Cases</h4>' + (props ?
